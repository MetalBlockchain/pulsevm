...
use crate::chain::{
    Action, AuthorizationManager, Controller, PermissionLevel, PublicKey, Transaction,
    error::ChainError, pulse_assert, wasm_runtime::WasmContext,
};
...
-> impl Fn(Caller<'_, WasmContext>, u32, u32, u32, u32, u32, u32) -> Result<i32, wasmtime::Error> {
