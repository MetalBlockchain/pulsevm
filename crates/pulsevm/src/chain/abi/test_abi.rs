pub const PULSE_ABI: &str = r#"
{
    ...
    "structs": [
        ...
        {
            "name": "eosio_global_stateram",
            "base": "",
            "fields": [
                {
                    "name": "ram_price_per_byte",
                    "type": "asset"
                },
                {
                    "name": "max_per_user_bytes",
                    "type": "uint64"
                },
                {
                    "name": "ram_fee_percent",
                    "type": "uint16"
                },
                {
                    "name": "total_ram",
        ...
        {
            "name": "eosio_global_statesxpr",
            "base": "",
            "fields": [
                {
                    "name": "max_bp_per_vote",
                    "type": "uint64"
                },
                {
                    "name": "min_bp_reward",
