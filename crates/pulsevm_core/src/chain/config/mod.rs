...
/// a buggy system contract can't spin a node forever. `POINTS_PER_US * 1_000_000`
/// is ~1 second of reference compute: ~38x a full `max_transaction_cpu_usage` of
/// 1e9, comfortably above any real system action, yet still a hard stop that
/// bounds a runaway loop until a proper native-code checktime deadline exists.
pub const IMPLICIT_TX_CPU_BUDGET: u64 = POINTS_PER_US * 1_000_000;
