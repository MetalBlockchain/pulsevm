...
const FORWARD_SETCODE_FEATURE_DIGEST: [u8; 32] = [
    0x26, 0x52, 0xf5, 0xf9, 0x60, 0x06, 0x29, 0x41, 0x09, 0xb3, 0xdd, 0x0b, 0xbd, 0xe6, 0x36,
    0x96, 0xf5, 0x53, 0x24, 0xaf, 0x45, 0x2b, 0x79, 0x9e, 0xe1, 0x37, 0xa8, 0x1a, 0x90, 0x5e,
    0xed, 0x25,
];

const RAM_RESTRICTIONS_FEATURE_DIGEST: [u8; 32] = [
    0x4e, 0x7b, 0xf3, 0x48, 0xda, 0x00, 0xa9, 0x45, 0x48, 0x9b, 0x2a, 0x68, 0x17, 0x49, 0xeb,
    0x56, 0xf5, 0xde, 0x00, 0xb9, 0x00, 0x01, 0x4e, 0x13, 0x7d, 0xda, 0xe3, 0x9f, 0x48, 0xf6,
    0x9d, 0x67,
];

const RESTRICT_ACTION_TO_SELF_FEATURE_DIGEST: [u8; 32] = [
    0xad, 0x9e, 0x3d, 0x8f, 0x65, 0x06, 0x87, 0x70, 0x9f, 0xd6, 0x8f, 0x4b, 0x90, 0xb4, 0x1f,
    0x7d, 0x82, 0x5a, 0x36, 0x5b, 0x02, 0xc2, 0x3a, 0x63, 0x6c, 0xef, 0x88, 0xac, 0x2a, 0xc0,
    0x0c, 0x43,
];

const REPLACE_DEFERRED_FEATURE_DIGEST: [u8; 32] = [
    0xef, 0x43, 0x11, 0x2c, 0x65, 0x43, 0xb8, 0x8d, 0xb2, 0x28, 0x3a, 0x2e, 0x07, 0x72, 0x78,
    0xc3, 0x15, 0xae, 0x2c, 0x84, 0x71, 0x9a, 0x8b, 0x25, 0xf2, 0x5c, 0xc8, 0x85, 0x65, 0xfb,
    0xea, 0x99,
];

const NO_DUPLICATE_DEFERRED_ID_FEATURE_DIGEST: [u8; 32] = [
    0x4a, 0x90, 0xc0, 0x0d, 0x55, 0x45, 0x4d, 0xc5, 0xb0, 0x59, 0x05, 0x5c, 0xa2, 0x13, 0x57,
    0x9c, 0x6e, 0xa8, 0x56, 0x96, 0x77, 0x12, 0xa5, 0x60, 0x17, 0x48, 0x78, 0x86, 0xa4, 0xd4,
    0xcc, 0x0f,
];
