...
#include <pulsevm/transaction.hpp>
#include <pulsevm/config.hpp>
...
FC_REFLECT(pulsevm::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(pulsevm::chain::key_weight, (key)(weight) )
FC_REFLECT(pulsevm::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(pulsevm::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(pulsevm::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(pulsevm::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(pulsevm::chain::shared_public_key, (pubkey))
