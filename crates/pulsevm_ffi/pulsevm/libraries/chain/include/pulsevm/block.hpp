#pragma once
#include <pulsevm/block_header.hpp>
...
FC_REFLECT(pulsevm::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(pulsevm::chain::signed_block, (pulsevm::chain::signed_block_header), (transactions)(block_extensions) )
