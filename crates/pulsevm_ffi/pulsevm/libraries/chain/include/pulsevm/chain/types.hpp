...
namespace pulsevm::chain {
   ...
   using session = chainbase::database::session;
   ...
   /**
    *  Important notes on using chainbase objects in pulsevm code:
    *
    ...
    *  others are due to requirements to ensure determinism in the pulsevm chain library.
    *
...
FC_REFLECT_EMPTY( pulsevm::chain::void_t )