...
using action_name    = pulsevm::chain::action_name;
...
FC_REFLECT( pulsevm::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( pulsevm::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( pulsevm::chain::setabi                           , (account)(abi) )
FC_REFLECT( pulsevm::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( pulsevm::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( pulsevm::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( pulsevm::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( pulsevm::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( pulsevm::chain::onerror                          , (sender_id)(sent_trx) )
