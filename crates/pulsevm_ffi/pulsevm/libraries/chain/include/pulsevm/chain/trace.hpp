...
FC_REFLECT( pulsevm::chain::account_delta,
            (account)(delta) )

FC_REFLECT( pulsevm::chain::action_trace,
...
// @ignore except_ptr
FC_REFLECT( pulsevm::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
