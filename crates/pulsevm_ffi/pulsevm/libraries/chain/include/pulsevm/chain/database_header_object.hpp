...
CHAINBASE_SET_INDEX_TYPE(pulsevm::chain::database_header_object, pulsevm::chain::database_header_multi_index)

FC_REFLECT( pulsevm::chain::database_header_object, (version) )
