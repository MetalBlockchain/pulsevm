...
CHAINBASE_SET_INDEX_TYPE(pulsevm::chain::transaction_object, pulsevm::chain::transaction_multi_index)

FC_REFLECT(pulsevm::chain::transaction_object, (expiration)(trx_id))
