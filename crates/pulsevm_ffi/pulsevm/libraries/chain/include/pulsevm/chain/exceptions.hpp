 ...
 * The main difference here is that if the exception caught isn't of type "pulsevm::chain::chain_exception"
...
#define EOS_RETHROW_EXCEPTIONS(exception_type, FORMAT, ... ) \
      ...
      throw;\
   } catch (pulsevm::chain::chain_exception& e) { \
...
namespace pulsevm { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( action_validate_exception, chain_exception,
      ...
      FC_DECLARE_DERIVED_EXCEPTION( pulsevm_assert_message_exception, action_validate_exception,
                                    3050003, "pulsevm_assert_message assertion failure" )
      FC_DECLARE_DERIVED_EXCEPTION( pulsevm_assert_code_exception, action_validate_exception,
                                    3050004, "pulsevm_assert_code assertion failure" )
      ...
      FC_DECLARE_DERIVED_EXCEPTION( restricted_error_code_exception, action_validate_exception,
                                    3050011, "pulsevm_assert_code assertion failure uses restricted error code value" )
