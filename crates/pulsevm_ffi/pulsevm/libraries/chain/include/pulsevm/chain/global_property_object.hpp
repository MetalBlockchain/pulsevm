...
#include <pulsevm/chain/chain_config.hpp>
#include <pulsevm/chain/wasm_config.hpp>
...
CHAINBASE_SET_INDEX_TYPE(pulsevm::chain::global_property_object, pulsevm::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(pulsevm::chain::dynamic_global_property_object,
                         pulsevm::chain::dynamic_global_property_multi_index)

FC_REFLECT(pulsevm::chain::global_property_object,
   (configuration)(chain_id)(wasm_configuration)
)

FC_REFLECT(pulsevm::chain::dynamic_global_property_object, (global_action_sequence))
