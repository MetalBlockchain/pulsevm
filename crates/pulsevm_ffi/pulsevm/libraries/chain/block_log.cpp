...
#include <pulsevm/block_log_config.hpp>
#include <pulsevm/exceptions.hpp>
#include <pulsevm/log_catalog.hpp>
#include <pulsevm/log_data_base.hpp>
#include <pulsevm/log_index.hpp>
...
namespace pulsevm { namespace chain {
   ...
   namespace {
      ...
      using block_log_index = pulsevm::chain::log_index<block_log_exception>;
   ...
   using block_log_catalog = pulsevm::chain::log_catalog<block_log_data, block_log_index, block_log_verifier>;
