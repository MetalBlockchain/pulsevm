...
namespace fc {
  void to_variant(const pulsevm::chain::name& c, fc::variant& v) { v = c.to_string(); }
  void from_variant(const fc::variant& v, pulsevm::chain::name& check) { check.set( v.get_string() ); }
} // fc