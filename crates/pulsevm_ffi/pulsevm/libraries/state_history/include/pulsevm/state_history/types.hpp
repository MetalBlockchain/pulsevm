...
// clang-format off
FC_REFLECT(pulsevm::state_history::table_delta, (struct_version)(name)(rows));
FC_REFLECT(pulsevm::state_history::block_position, (block_num)(block_id));
FC_REFLECT_EMPTY(pulsevm::state_history::get_status_request_v0);
FC_REFLECT(pulsevm::state_history::get_status_result_v0, (head)(last_irreversible)(trace_begin_block)(trace_end_block)(chain_state_begin_block)(chain_state_end_block)(chain_id));
FC_REFLECT(pulsevm::state_history::get_blocks_request_v0, (start_block_num)(end_block_num)(max_messages_in_flight)(have_positions)(irreversible_only)(fetch_block)(fetch_traces)(fetch_deltas));
FC_REFLECT(pulsevm::state_history::get_blocks_ack_request_v0, (num_messages));
FC_REFLECT(pulsevm::state_history::get_blocks_result_base, (head)(last_irreversible)(this_block)(prev_block)(block));
FC_REFLECT_DERIVED(pulsevm::state_history::get_blocks_result_v0, (pulsevm::state_history::get_blocks_result_base), (traces)(deltas));
// clang-format on
