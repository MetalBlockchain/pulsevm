...
// Initial value for pulsevm ABI. This value affects consensus; if different
// nodeos versions have different versions of the initial pulsevm ABI, then
// they could potentially fork. See https://github.com/pulsevm/eos/issues/7794
//
// This is a capture of the ABI produced by versions 1.7 and 1.8.

unsigned char pulsevm_abi_bin[2132] = {
