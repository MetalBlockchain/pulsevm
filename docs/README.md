...
| [optimistic-parallel-execution.md](./optimistic-parallel-execution.md) | Consensus-safe ordered speculation, full transaction shadow workers, dependency tracking, fallbacks, and benchmarks | Default-off full-stack shadow execution plus bounded contract-row commit |
